...
from TusharMusic.core.call import Tushar, autoend, counter
from TusharMusic.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
import logging
    ...
    while True:
        ...
        try:
            ...
            for chat_id in chatss:
                try:
                    users = len(await Tushar.call_listeners(chat_id))
